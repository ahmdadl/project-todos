<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{
            ...
            <div>
                <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" x-model='name'
            ...
            <div class="mt-4">
                <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" x-model='email'
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-jet-button class="ml-4" bg='teal' type='submit' x-bind:disabled="name.length < 4 || !$store.common.testMail(email) || password.length < 8 || password !== conf">
                    {{ __('Register') }}
                </x-jet-button>
            </div>
        </form>
