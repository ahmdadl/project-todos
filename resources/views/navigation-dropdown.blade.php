<nav x-data="{ open: false }" class="fixed top-0 left-0 z-10 border-b dark:bg-gray-900 dark:border-gray-900">
    ...
    <div class="relative w-screen px-4 text-white bg-blue-900 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex items-center flex-shrink-0">
                    <a href="/projects" title="app logo" aria-label="app logo">
                        <x-jet-application-mark class="block w-auto h-9" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 capitalize sm:-my-px sm:ml-10 sm:flex">
            ...
            <div class="flex items-center -mr-2 sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500" aria-label="toggle menu">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-gray-200 sm:hidden dark:bg-gray-700">
